...
def salva_login_artista():
    ...
    dao.usuario.insere_artista(nome, sexo, telefone, cpf, cep, email, senha, logradouro, bairro, localidade, uf)
...
def salva_login_restaurante():
    ...
    dao.usuario.insere_empreendimento(nome, telefone, cnpj, cep, email, senha,logradouro, bairro, localidade, uf)
    return render_template('easy_to_sing.html')
